            ...
            <div style={{ width: ' 800px', height: '450px', borderRadius: '6px', background: '#fff', display: 'flex' }}>
                <WrapperContainerLeft style={{ borderRight: '1px solid gray' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        <InputFormComponent placeholde="Nhập mật khẩu" style={{ marginBottom: '10px' }} type={isShowPassword ? "text" : "Nhập mật khẩu"}></InputFormComponent>
                    </div>
                    <div style={{ position: 'relative' }}>
                        <span style={{ zIndex: 10, position: 'absolute', top: '4px', right: '8px' }}>
                            {isShowPassword ? (<EyeFilled style={{ fontSize: '20px' }} />) : (<EyeInvisibleFilled style={{ fontSize: '20px' }} />)}
                        </span>
                        <InputFormComponent placeholde="Nhập lại mật khẩu" style={{ marginBottom: '10px' }} type={isShowPassword ? "text" : "Nhập mật khẩu"}></InputFormComponent>
                    </div>



                    <ButtonComponent size={40} styleButton={{ background: '#dc3545', height: '48px', width: '100%', border: 'none', borderRadius: '4px', margin: '26px 0 10px' }} textButton={'Đăng ký'} styleTextButton={{ color: '#efefef', fontSize: '15px', fontWeight: '700' }}></ButtonComponent>
                    <p style={{ fontSize: '16px' }}>Bạn đã có tài khoản? <WrapperStyleTextLight>Đăng nhập</WrapperStyleTextLight></p>
